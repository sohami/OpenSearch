...
public abstract class SearchContext implements Releasable {
    ...
    public static final BucketCollectorProcessor NO_OP_BUCKET_COLLECTOR_PROCESSOR = new BucketCollectorProcessor() {
        ...
        @Override
        public List<Aggregator> processOnReduce(Collection<Collector> collectors) {
            // should not be called when there is no aggregation collector
            throw new IllegalStateException("processOnReduce should not be called on NO_OP_BUCKET_COLLECTOR_PROCESSOR");
        }
    };
