...
public class QueryPhase {
    ...
    static boolean executeInternal(SearchContext searchContext, QueryPhaseSearcher queryPhaseSearcher) throws QueryPhaseExecutionException {
        ...
        try {
            ...
            final List<CollectorManager<? extends Collector, ReduceableSearchResult>>
                allExceptGlobal =
            ...
            if (allExceptGlobal.isEmpty() == false) {
                collectors.add(createMultiCollectorContext(allExceptGlobal));
            }
